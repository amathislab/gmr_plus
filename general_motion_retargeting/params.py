...
ROBOT_XML_DICT = {
    ...
    "myofullbody": ASSET_ROOT / "muscle_model"/ "body" / "myofullbody.xml",
...
IK_CONFIG_DICT = {
    ...
    "smplh":{
        ...
        "unitree_g1_with_hands": IK_CONFIG_ROOT / "smplh_to_g1.json",
        "unitree_h1": IK_CONFIG_ROOT / "smplh_to_h1.json",
        "unitree_h1_2": IK_CONFIG_ROOT / "smplh_to_h1_2.json",
        "booster_t1": IK_CONFIG_ROOT / "smplh_to_t1.json",
        "booster_t1_29dof": IK_CONFIG_ROOT / "smplh_to_t1_29dof.json",
        "stanford_toddy": IK_CONFIG_ROOT / "smplh_to_toddy.json",
        "fourier_n1": IK_CONFIG_ROOT / "smplh_to_n1.json",
        "engineai_pm01": IK_CONFIG_ROOT / "smplh_to_pm01.json",
        "kuavo_s45": IK_CONFIG_ROOT / "smplh_to_kuavo.json",
        "hightorque_hi": IK_CONFIG_ROOT / "smplh_to_hi.json",
        "galaxea_r1pro": IK_CONFIG_ROOT / "smplh_to_r1pro.json",
        "berkeley_humanoid_lite": IK_CONFIG_ROOT / "smplh_to_bhl.json",
